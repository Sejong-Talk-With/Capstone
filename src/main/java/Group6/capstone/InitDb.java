...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Point point1 = Point.createPoint("광개토관", 0, 0, 11, 37.550269, 127.073362,"/img/광개토관.jpg");
            point1.setRange(37.550776, 127.072801,37.549831, 127.074230);
            Point point2 = Point.createPoint("영실관 입구", 0, 0, 8, 37.552101, 127.073609,"/img/영실관.jpg");
            point2.setRange(37.552498, 127.072948, 37.551548, 127.073985);
            Point point3 = Point.createPoint("애지헌", 0, 0, 13, 37.551001, 127.074609,"/img/애지헌.jpg");
            point3.setRange(37.551082, 127.074665,37.550196, 127.075771);
            Point point4 = Point.createPoint("AI센터", 0, 0,9, 37.550257, 127.075006,"/img/AI센터.jpg");
            point4.setRange(37.551082, 127.074665,37.550196, 127.075771);
            Point point5 = Point.createPoint("세종대 정문", 0, 0,17, 37.548805, 127.074895,"/img/정문.jpg");
